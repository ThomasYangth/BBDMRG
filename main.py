...
def compare_DMRG_to_ED_X (mpo, k, chi_max=50, numsweeps=10, which = "SM", M=None, Mb=None, method="biortho", stop_if_not_converge = True):
    ...
    Ms, _, Es = doDMRG_excited(M, Mb, mpo, chi_max, k, expected_gap=0.5, numsweeps=numsweeps, method=method, which=which, stop_if_not_converge=stop_if_not_converge, log_write=log_write)
